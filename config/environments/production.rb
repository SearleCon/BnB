Bnbeezy::Application.configure do
  ...
  config.assets.prefix = "/bnbeezy/assets"
  ...
  config.action_mailer.default :from => "support@searleconsulting.co.za"
  ...
  # config.logger = ActiveSupport::TaggedLogging.othernew(SyslogLogger.othernew)
